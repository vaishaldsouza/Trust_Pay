...
val TrustPayPrimaryLight = Color(0xFF101828)
val TrustPayOnPrimaryLight = Color(0xFFFFFFFF)
val TrustPayPrimaryContainerLight = Color(0xFF141B2C)
val TrustPayOnPrimaryContainerLight = Color(0xFFDCE2F9)

val TrustPaySecondaryLight = Color(0xFF006C49)
val TrustPayOnSecondaryLight = Color(0xFFFFFFFF)
val TrustPaySecondaryFixedLight = Color(0xFF6FFBBE)
val TrustPaySecondaryFixedDimLight = Color(0xFF4EDEA3)
val TrustPayOnSecondaryFixedLight = Color(0xFF002113)
